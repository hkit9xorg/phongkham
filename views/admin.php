        ...
        <form method="post" enctype="multipart/form-data" class="space-y-3">
            ...
            <?php elseif ($module === 'articles'): ?>
                ...
                <label class="form-control">
                    ...
                    <?php if (!empty($currentRecord['thumbnail'])): ?>
                        <img src="<?= htmlspecialchars($currentRecord['thumbnail']) ?>" class="mt-2 rounded w-full h-32 object-cover" alt="Thumbnail hiện tại">
                    <?php endif; ?>
                </label>
            <?php else: ?>
