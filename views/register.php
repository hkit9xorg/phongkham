<div class="max-w-xl mx-auto mt-10">
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            ...
            <p class="text-sm text-gray-500">Mật khẩu mặc định sau khi đăng ký: 123456. Bạn có thể đổi mật khẩu tại quầy lễ tân.</p>
            <?php if ($errors): ?>
            ...
            <form method="POST" class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    <input type="email" name="email" class="input input-bordered" required placeholder="user@example.com">
                </div>
                <div class="form-control">
                    <label class="label"><span class="label-text">Số điện thoại</span></label>
                    <input type="tel" name="phone" class="input input-bordered" placeholder="09xx">
                </div>
